...
- **Hybrid Analytics Engine**:
  - **Offline Knowledge-Base (KB) Engine**: Deterministic pattern matching using a signature database to resolve known firmware, memory, storage, and kernel crash signatures.
...
- **Log Sources**: U-Boot/firmware logs, Linux kernel `dmesg`, service logs.
